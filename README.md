...
- [playwright-spec-doc-reporter](https://github.com/pnakhat/playwright-spec-doc-reporter) - HTML reporter with BDD/Gherkin annotations, AI-powered failure analysis, self-healing suggestions, Jira/Xray integration, and inline API request/response display.
