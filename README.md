...
- [Testing 3D applications with Playwright on GPU](https://blog.promaton.com/testing-3d-applications-with-playwright-on-gpu-1e9cfc8b54a9) - Recipe to enable hardware acceleration for Playwright tests on CI.
- [Playwright Skill: Train Your AI Agent to Write Better Tests](https://testdino.com/blog/playwright-skill/) - Guide to using Playwright Skills so AI agents can understand, generate, and debug your Playwright tests more reliably.
