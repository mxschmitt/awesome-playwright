...
- [FixSense](https://fixsense.dev) - AI-powered root cause analysis and auto-fix for Playwright CI failures. Installs as a GitHub App, analyzes failing tests, and opens fix PRs automatically.
